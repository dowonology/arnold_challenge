...
#        object_prim = add_reference_to_stage('/root/arnold/Ufo/Low_poly_UFO.usd', object_prim_path)    
...
#        import pdb 
#        pdb.set_trace()
        print(f'object_prim_path : {object_prim_path}')
        print(f'\n\npostioin : {position}\n\n')
        print(f'\n\nrotation : {rotation}\n\n')
